  ...
  return (
    <Layout
      ...
      _header={{
        title: (
          <VStack>
            <H2 color={colors.white}>{getTitle()}</H2>
            <BodySmall color={colors.white} textTransform="inherit">
              {getSubTitle()}
            </BodySmall>
          </VStack>
        ),
    ...
    <Stack>
      {!searchState ? (
        <FilterButton
          ...
          _button={{ bg: colors.white, px: "15px", py: "2" }}
          _filterButton={{
            rightIcon: "",
            bg: colors.white,
      ...
      <VStack>
        <Box pt="0" p="5" mb="4" roundedBottom={"xl"} shadow={2}>
          <MyCoursesComponent
          ...
          <Actionsheet.Content alignItems={"left"} bg={colors.cardBg}>
            <HStack justifyContent={"space-between"}>
              <Stack p={5} pt={2} pb="15px">
                <H2 color={colors.white}>{t("SORT")}</H2>
              </Stack>
              <IconByName
