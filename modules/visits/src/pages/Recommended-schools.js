import { H2, IconByName, Layout, FilterButton, DEFAULT_THEME } from "@shiksha/common-lib";
import { useTranslation } from "react-i18next";
import React, { useState } from "react";
import { Link, useParams } from "react-router-dom";
import { Box, HStack, Text, VStack, Button, Actionsheet, Stack, Divider } from "native-base";
            ...
            <VStack space={6}>
              <Box>
                <HStack alignItems="center" justifyContent="space-between">
                  <Box>
                    <H2>Schools</H2>
                    <Text fontSize="xs">05 Schools not visited in last 2 months</Text>
                  </Box>
                  <Button
                    variant="outline"
                    onPress={() => {
